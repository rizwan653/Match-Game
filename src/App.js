...
class App extends Component {
  ...
  imageClick = thumbnailUrl => {
    ...
    const imageValue = imagesList.filter(
      eachVal => eachVal.thumbnailUrl === thumbnailUrl,
    )
    ...
    return (
      <>
        <nav className="nav-container">
          <ul className="logo-score-flex-container">
            ...
            <li className="score-container">
              ...
              <img
                ...
                alt="timer"
              />
              <p className="time-color">{time} sec</p>
            </li>
          </ul>
        </nav>
          ...
          <div className="content-div">
            {!isTrue && (
              <div className="first-div">
                <img src={imgUrl} alt="match" className="big-image" />
                <ul className="tabs-container">
                  {tabsList.map(eachValue => (
                    <li key={eachValue.tabId} className="each-tab">
                      <button
                        type="button"
                        className={`button ${
                ...
                <ul className="thumbnails-container">
                  {thumbnailList.map(eachImage => (
                    <li key={eachImage.id} className="each-thumbnail">
                      <button
                        className="thumbnail-btn"
                        type="button"
                        onClick={() => this.imageClick(eachImage.thumbnailUrl)}
                      >
                        <img
            ...
            {isTrue && (
              <div className="main-container">
                <div className="top-container">
                  <div className="gameoverpage-container">
                    <img
